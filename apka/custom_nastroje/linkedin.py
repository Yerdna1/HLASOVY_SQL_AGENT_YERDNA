...
from apka.widgets.spolocne import zapisovac as logger, scratch_pad_adresar

# Directory for saving LinkedIn posts
...
async def draft_linkedin_post_handler(topic):
    ...
    try:
        ...
        filepath = os.path.join(scratch_pad_adresar, "linkedin_post.md")
